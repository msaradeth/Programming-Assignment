...
public class ProductAdapter3 extends BaseAdapter {
	...
	private ProductThreeColumn threeColproduct;
	private Activity activity;
	private LayoutInflater layoutInflater;
	private List<ProductThreeColumn> alProduct;
	private ImageCache imageCache;
	private String action;
	private int myPosition;	
	
	//Constructor
	public ProductAdapter3(Activity activity, LayoutInflater layoutInflater, List<ProductThreeColumn> alProduct, OnClickListener callback, String callFrom, String action, ImageCache imageCache) {		
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		threeColproduct = alProduct.get(position);
    	...
    	for (int ii=0; ii<alHolder.size(); ii=ii+1) { 
       		...
       		switch (ii) {
       			case 0:
       				product = threeColproduct.col1;
       				break;
       			case 1: 
       				product = threeColproduct.col2;
       				break;  
       			case 2: 
       				product = threeColproduct.col3;
       				break;          				
       		}      
       		if (product != null) {
           		holder.url = product.getImageUrl();
           		//Display data to view
           		displayData(holder, product, threeColproduct);         			
       		}
	...
	//Display data to view
	public void displayData(ViewHolder holder, Product product, ProductThreeColumn threeColproduct) {
    	...
    	//Draw from memory cache if exist else load product image from asset folder and cache it
   		...
   		final Product tmpProduct = threeColproduct.col1;
        ...
        final Product tmpProduct2 = threeColproduct.col2;
        ...
        final Product tmpProduct3 = threeColproduct.col3;
